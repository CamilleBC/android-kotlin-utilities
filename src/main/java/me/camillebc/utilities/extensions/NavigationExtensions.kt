...
import me.camillebc.utilities.R
...
fun BottomNavigationView.setupWithNavController(
    ...
    navGraphIds.forEachIndexed { index, navGraphId ->
        ...
        val isFirstNavFragment = index == 0
        if (isFirstNavFragment) {
        ...
        if (this.selectedItemId == graphId) {
            ...
            attachNavHostFragment(fragmentManager, navHostFragment, isFirstNavFragment)
        } else {
